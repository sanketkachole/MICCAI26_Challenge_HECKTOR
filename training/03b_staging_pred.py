#!/usr/bin/env python3
r"""
HECKTOR 2026 - Step 03b: TN staging trained on PREDICTED-mask metadata (OOF).
Same logic as step 03, but --meta should be case_metadata_pred.csv so the N-rule
thresholds and the T-model match what the container sees at test time.
